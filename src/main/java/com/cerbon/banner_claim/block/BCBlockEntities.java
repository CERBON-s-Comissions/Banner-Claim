...
public class BCBlockEntities {
    ...
    public static final RegistryObject<BlockEntityType<BannerClaimBlockEntity>> BANNER_CLAIM = BLOCKS_ENTITIES.register("banner_claim", () ->
            BlockEntityType.Builder.of(BannerClaimBlockEntity::new, BCBlocks.IRON_BANNER.get(), BCBlocks.WALL_IRON_BANNER.get(), BCBlocks.GOLD_BANNER.get(), BCBlocks.WALL_GOLD_BANNER.get(), BCBlocks.EMERALD_BANNER.get(), BCBlocks.WALL_EMERALD_BANNER.get(), BCBlocks.DIAMOND_BANNER.get(), BCBlocks.WALL_DIAMOND_BANNER.get()).build(null));
