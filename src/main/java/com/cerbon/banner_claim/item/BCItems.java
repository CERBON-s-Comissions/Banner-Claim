...
public class BCItems {
    ...
    public static final RegistryObject<Item> IRON_BANNER = ITEMS.register("iron_banner_claim", () -> new BannerClaimItem(BCBlocks.IRON_BANNER.get(), BCBlocks.WALL_IRON_BANNER.get(), new Item.Properties().stacksTo(16)));
